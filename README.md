...
CLERK_SECRET_KEY=
# Optional: override ClerkJS script URL if the default Clerk endpoint is unavailable
NEXT_PUBLIC_CLERK_JS_URL=https://unpkg.com/@clerk/clerk-js@5.71.0/dist/clerk.browser.js
